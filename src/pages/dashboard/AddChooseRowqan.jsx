    ...
    <form className="grid grid-cols-12 gap-4">
      ...
      <div className="col-span-12">
        <label className="block font-medium mb-2">
          {t.reservationType} <span className="text-red-500">*</span>
        </label>
            ...
            <div className="col-span-12">
              <input
                ...
                className={`w-full p-2 border rounded ${
                  typeError && !otherType ? "border-red-500" : "border-gray-300"
                }`}
        ...
        {typeError && (
          <div className="mt-2 text-red-500 text-sm">{typeError}</div>
        )}
      </div>
      ...
      <div className="col-span-12">
        <h3 className="text-lg font-medium text-gray-800">
          {t.rating.title} <span className="text-red-500">*</span>
        </h3>
        <div className="relative">
          <select
            value={rating}
          ...
          >
            ...
            <option value="three" className="text-yellow-500">
              {t.rating.stars.three}
            </option>
            <option value="four" className="text-yellow-500">
              {t.rating.stars.four}
            </option>
            <option value="five" className="text-yellow-500">
              {t.rating.stars.five}
            </option>
          ...
          {rating === "other" && (
            <div className="mt-3">
              <input
                ...
                max="10"
                className={`w-full p-2 border rounded ${
                  ratingError && !otherRating ? "border-red-500" : "border-gray-300"
                }`}
      ...
      {reservationType === "family" && (
        <div className="col-span-12">
          ...
          <div className="flex items-center gap-3 mb-3">
            <button
              type="button"
              className="border border-gray-300 rounded-full p-2 w-10 h-10 flex items-center justify-center"
              onClick={() => setFamilyCount(Math.max(1, familyCount - 1))}
            >
              -
            </button>
            <span
              className="text-2xl font-medium text-center w-10"
            >
              {familyCount}
            </span>
            <button
      ...
      {/* Duration and Date */}
      <div className="col-span-12">
        <h3 className="text-lg font-medium text-gray-800">{t.duration.title}</h3>

        {/* Start Date */}
        <div className="mb-3">
          <label className="block font-medium mb-2">
            {t.duration.startDate} <span className="text-red-500">*</span>
          </label>
          <DatePicker
            selected={startDate}
            ...
            {duration === "other" && (
              <div className="col-span-12">
                <input
                  type="text"
                  className={`w-full p-2 border rounded ${
                    durationError && !otherDuration ? "border-red-500" : "border-gray-300"
                  }`}
      ...
      <div className="col-span-12">
        <label className="block font-medium mb-2">
          {t.visitors.title} <span className="text-red-500">*</span>
        </label>
          ...
          {Object.entries(facilities).map(([key, checked]) => (
            <div key={key} className="col-span-1">
              <div className="flex items-center">
                ...
                />
                <label className="text-gray-700" htmlFor={key}>
                  {t.facilities[key]}
                </label>
              </div>
            </div>
      ...
      <div className="col-span-12 mt-3">
        <label className="block font-medium mb-2">
          {t.budget.title} <span className="text-red-500">*</span>
        </label>
        <div>
          <input
            type="number"
            ...
            className={`w-full p-2 border rounded ${budgetError ? "border-red-500" : "border-gray-300"}`}
            min="0"
            step="0.01"
          />
          {budgetError && (
      ...
      <div className="col-span-12 mt-3">
        ...
        <input
          ...
          className={`w-full p-2 border rounded ${fullNameError ? "border-red-500" : "border-gray-300"}`}
        />
        {fullNameError && (
        ...
        <div className="flex gap-3">
          {["call", "whatsapp"].map((method) => (
            <div
              key={method}
              className={`
                cursor-pointer rounded border p-3 flex-grow
                ${
      ...
      {/* {contactMethod === "call" && (
        <div className="col-span-12 mt-3">
          <button
            ...
            className="bg-green-500 hover:bg-green-600 text-white w-full flex items-center justify-center p-3 rounded"
          >
            <PhoneCall
              className="mr-2"
      ...
      <div className="col-span-12 mt-4">
        <div className="flex gap-3">
          ...
          <button
            type="button"
            onClick={resetForm}
            className="bg-red-500 hover:bg-red-600 text-white w-full py-3 rounded"
          >
...
export default AddChooseRowqan;
