...
function DeleteModule({ showModal, handleClose, handleDelete, id }) {
  ...
  >    <div class="relative p-4 w-full max-w-md max-h-full">
    <div
      ...
      >            <button onClick={handleClose}type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{lang ==='ar'? "هل انت متاكد من حذف هذا العنصر" : "Are you sure you want to delete this item?  "}</h3>
                <button onClick={() => { 
  handleDelete(id); 
  handleClose(); 
